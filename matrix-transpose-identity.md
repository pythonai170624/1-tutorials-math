...
מטריצת הזהות היא מטריצה ריבועית בסדר n×n שבה כל האיברים באלכסון הראשי הם 1, וכל שאר האיברים הם 0. אם נסמן את מטריצת הזהות ב-I, אז I = [δij], כאשר δij = 1 אם i=j, ו-δij = 0 אם i≠j.

### דוגמה למטריצת זהות
מטריצת זהות מסדר 3×3:
```
I = [1 0 0]
    [0 1 0]
    [0 0 1]
