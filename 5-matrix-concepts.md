...
1. חישוב הקופקטורים:
   -  $d_{11} = 4$: Co is $(-1)^{1+1} \times \det([6]) = 1 \times 6 = 6$
   -  $d_{12} = 7$: Co is $(-1)^{1+2} \times \det([2]) = -1 \times 2 = -2$
   -  $d_{21} = 2$: Co is $(-1)^{2+1} \times \det([7]) = -1 \times 7 = -7$
   -  $d_{22} = 6$: Co is $(-1)^{2+2} \times \det([4]) = 1 \times 4 = 4$
